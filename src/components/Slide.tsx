...
const Slide:React.FC<propsType> =({img,title,mainTitle,price})=>{
    return <div className="outline-none border-none relative">
      <div className="absolute left-[30px] md:left-[70px] mx-w-[250px] sm:max-w-[350px] top[50%]-translate-y-[50%] space-y-z lg:space-y-4
      bg-[#ffffffa2] sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none">  
        ...
        inline-black cusor-pointer hover:bg-blackish">
          Shop Now
        </div>
